...
// 'toMatchSnapshot' grabs a snapshot of the component and creates a folder
// 'u' updates snapshot once component changes or is edited
// npm test -- --coverage to check test coverage
it('expect to render Card component', () => {
